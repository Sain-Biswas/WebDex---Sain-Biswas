...
export const Fetch_Card = async (name_id_init, name_id_final) => {
    let Pokemon = [];
    for (let name_id = name_id_init; name_id <= name_id_final; name_id++) {
...
const colourTypePickerSwitch = (typePKMN) => {
    switch (typePKMN) {
        case "normal":
            return "#949495"
        case "electric":
...
export const colorArrayProvider = (parent) => {
    let colorArray = []
    if (parent.types.length === 1) {
        colorArray.push(colourTypePickerSwitch(parent.types[0]))
        colorArray.push('#000000')
    }
    else {
        colorArray.push(colourTypePickerSwitch(parent.types[0]))
        colorArray.push(colourTypePickerSwitch(parent.types[1]))
    }
    return colorArray
}
...
export function TypeCodeReturner(props) {
    switch (props.Value) {
        case "fire":
            return (<div className="card-type-sym">
                <div
                    className="card-type-back"
                    style={{
                        background:
                            "linear-gradient(53deg, rgba(242,101,30,1) 38%, rgba(246,148,71,1) 87%)"
                    }}
                ></div>
        ...
        case "dark":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(53deg, rgba(64,40,42,1) 24%, rgba(97,68,65,1) 59%, rgba(64,40,42,1) 95%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
        ...
        case "bug":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(53deg, rgba(153,175,41,1) 35%, rgba(197,209,110,1) 60%, rgba(165,171,66,1) 90%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
        ...
        case "dragon":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(53deg, rgba(75,69,207,1) 5%, rgba(111,96,196,1) 25%, rgba(75,69,207,1) 50%, rgba(111,96,196,1) 75%, rgba(75,69,207,1) 95%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
        ...
        case "electric":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(53deg, rgba(220,196,23,1) 8%, rgba(248,255,0,1) 37%, rgba(238,234,8,1) 57%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
        ...
        case "fairy":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(53deg, rgba(254,178,242,1) 5%, rgba(249,195,208,1) 25%, rgba(254,177,244,1) 50%, rgba(249,195,208,1) 75%, rgba(253,179,240,1) 95%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
        ...
        case "fighting":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(53deg, rgba(98,35,30,1) 5%, rgba(119,49,42,1) 25%, rgba(98,35,30,1) 50%, rgba(119,49,42,1) 75%, rgba(98,35,30,1) 95%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
        ...
        case "flying":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(53deg, rgba(136,168,255,1) 5%, rgba(107,137,219,1) 25%, rgba(136,168,255,1) 50%, rgba(107,137,219,1) 75%, rgba(136,168,255,1) 95%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
        ...
        case "ghost":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "radial-gradient(circle, rgba(111,81,173,1) 5%, rgba(93,73,135,1) 25%, rgba(111,81,173,1) 50%, rgba(93,73,135,1) 75%, rgba(111,81,173,1) 95%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
        ...
        case "grass":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(53deg, rgba(90,196,79,1) 23%, rgba(144,213,131,1) 58%, rgba(90,196,79,1) 82%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
        ...
        case "ground":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(53deg, rgba(200,165,87,1) 5%, rgba(207,165,121,1) 25%, rgba(200,165,87,1) 50%, rgba(207,165,121,1) 75%, rgba(200,165,87,1) 95%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
        ...
        case "ice":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(53deg, rgba(43,131,145,1) 15%, rgba(178,239,249,1) 98%, rgba(112,220,238,1) 50%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
        ...
        case "normal":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "radial-gradient(circle, rgba(191,181,155,1) 5%, rgba(200,196,178,1) 25%, rgba(191,181,155,1) 50%, rgba(200,196,178,1) 75%, rgba(191,181,155,1) 95%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
        ...
        case "poison":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(53deg, rgba(175,119,185,1) 2%, rgba(145,78,157,1) 24%, rgba(150,84,161,1) 68%, rgba(192,141,201,1) 94%, rgba(222,177,230,1) 100%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
        ...
        case "psychic":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(53deg, rgba(172,51,98,1) 4%, rgba(201,28,95,1) 20%, rgba(168,55,99,1) 50%, rgba(201,28,95,1) 80%, rgba(172,51,98,1) 97%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
                    ...
                    >
                        <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M455.925 425.184C455.925 425.184 391.365 476.963 262.893 455.536C165.423 439.279 113.437 331.833 113.437 274.079C113.437 137.149 214.783 105.988 283.3 105.988C351.816 105.988 396.513 172.788 396.513 224.508C396.513 276.228 359.933 321.466 303.006 321.466C246.08 321.466 229.22 281.501 229.22 244.758C229.22 208.016 258.947 195.071 286.058 195.071C313.169 195.071 322.452 218.217 322.452 238.11C322.452 258.004 307.017 265.128 294.143 265.128C281.269 265.128 279.996 258.633 275.069 251.807C270.141 244.982 281.353 219.146 262.893 219.146C244.433 219.146 240.992 248.847 240.992 248.847C240.992 248.847 247.722 306.18 303.006 305.191C358.291 304.201 384.518 261.461 376.896 219.146C369.274 176.83 328.207 131.865 256.133 140.951C184.059 150.037 154.632 222.861 167.603 300.685C180.574 378.51 273.807 423.602 347.112 407.379C420.418 391.156 493.429 338.086 493.429 203.533C493.429 68.9789 376.896 -11.9002 237.941 1.42913C98.9859 14.7584 12.729 136.242 18.2502 282.207C23.7714 428.172 162.275 507.669 279.394 511.766C396.513 515.864 468.312 448.067 468.312 448.067C468.312 448.067 484.459 433.668 478.128 422.424C471.798 411.18 455.925 425.184 455.925 425.184Z"
                            fill="white"
                        />
                    </svg>
                    {" "}
        ...
        case "rock":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(53deg, rgba(152,129,101,1) 5%, rgba(170,132,86,1) 25%, rgba(152,129,101,1) 50%, rgba(170,132,86,1) 75%, rgba(152,129,101,1) 95%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
        ...
        case "steel":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(53deg, rgba(83,82,82,1) 35%, rgba(119,116,115,1) 64%, rgba(138,138,138,1) 90%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
        ...
        case "water":
            return (<div className="card-type-sym">
                <div
                    ...
                    style={{
                        background:
                            "linear-gradient(53deg, rgba(53,156,246,1) 21%, rgba(68,170,247,1) 34%, rgba(90,189,249,1) 45%, rgba(116,212,252,1) 58%, rgba(102,203,252,1) 73%, rgba(0,136,255,1) 94%)"
                    }}
                ></div>
                <div className="card-type-name">
                    <svg
